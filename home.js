...
const tips = [
    ...
    'Friend me on <a href=\"https://discord.com\">Discord</a>: $yna#5745',   
    'You can suggest changes and updates to Incognito by asking me on my <a href=\"https://discord.com\">Discord</a>: $yna#5745',
    ''
];
...
function access(app) {
    ...
    app.search.input.setAttribute(
	    ...
	    app.main.tip.style.display = 'bold';
